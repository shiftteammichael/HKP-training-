...
public class NewsService extends Service {
    ...
    public class GetStoriesInBackground extends AsyncTask<Integer, Integer, String>
    {
        ...
        protected void onPostExecute(String result) {
            ...
            RemoteViews views = new RemoteViews("com.example.advancedwidgets", R.layout.new_app_widget);
            views.setTextViewText(R.id.tvTitle, titles.get(randVal));
            views.setTextViewText(R.id.tvDescription, descriptions.get(randVal));
